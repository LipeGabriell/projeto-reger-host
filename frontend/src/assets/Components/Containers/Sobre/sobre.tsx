    ...
    return (
        <>
            <section id='sobre' className='flex font column'>
                ...
                <div id='imgSobre'>
                    <img data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1000" data-aos-mirror="true" className='lixoDesktop' src={Lixo1} alt="" />
                    ...
                    <img data-aos="fade-right" data-aos-anchor-placement="top-top" data-aos-duration="1000" data-aos-mirror="true" className='lixoDesktop' src={Lixo3} alt="" />
                </div>
